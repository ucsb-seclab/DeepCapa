...
'''
This method extracts function and API calls in sequence from a block.
'''
...
def cfg_extractor(snapshot_id, sample_hash):
    ...
    try:
        ...
        #for Condon
        # with open("/home/saastha/data/ida8/idapro-8.0/loaders/ida_plugin/unique_apis.txt", "r") as my_file:
        #     unique_apis = my_file.read().split("\n")
        #for wiseau
        with open('/data/saastha/tools/ida8/idapro-8.0/loaders/ida_plugin/unique_apis.txt', "r") as my_file:
            unique_apis = my_file.read().split("\n")
